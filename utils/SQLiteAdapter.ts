    ...
    public static async init(): Promise<void> {
        ...
        await db.withTransactionAsync(async () => {
            await db.execAsync(`
                ...
                -- Create participants table with foreign key to activities
                ...
                -- Create expenses table with foreign keys to participants and activities
                ...
                -- Create participant_expenses junction table
                ...
                -- Create activity_types lookup table
